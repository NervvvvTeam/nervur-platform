  ...
  return (
    <div onMouseMove={handleMouseMove} style={{ background: "#FFFFFF", color: "#0A2540", fontFamily: "'Inter', system-ui, -apple-system, sans-serif", minHeight: "100vh", position: "relative" }}>
          ...
          <div style={{ border: `1px solid ${VG(0.1)}`, background: "rgba(255,255,255,0.75)", borderRadius: "12px", overflow: "hidden", backdropFilter: "blur(12px)" }}>
            ...
            <div style={{ padding: "14px 20px", borderBottom: `1px solid ${VG(0.08)}`, display: "flex", alignItems: "center", justifyContent: "space-between" }}>
              <div style={{ display: "flex", gap: "6px", alignItems: "center" }}>
                ...
                <span style={{ fontSize: "11px", color: "#6B7C93", marginLeft: "12px", letterSpacing: "1px" }}>nexus-studio.nervur.com</span>
              </div>
              ...
              {mode === "contenu" && (
                <>
                  ...
                  <div style={{ marginBottom: "24px" }}>
                    <label style={{ fontSize: "11px", letterSpacing: "2px", color: "#6B7C93", display: "block", marginBottom: "10px" }}>TYPE DE CONTENU</label>
                  ...
                  <div style={{ display: "grid", gridTemplateColumns: isMobile ? "1fr" : "1fr 1fr", gap: "16px", marginBottom: "24px" }}>
                    ...
                    <div>
                      <label style={{ fontSize: "11px", letterSpacing: "2px", color: "#6B7C93", display: "block", marginBottom: "8px" }}>SUJET / PRODUIT</label>
                  ...
                  <button onClick={generateContent} disabled={isGenerating || !canGenerateContent}
                    style={{
                      ...
                      border: "none", color: canGenerateContent ? "#FFFFFF" : "#6B7C93", fontWeight: 700, fontSize: "12px",
                  ...
                  {displayedText && (
                    <div style={{ marginTop: "24px", padding: isMobile ? "20px" : "28px", border: "1px solid rgba(74,222,128,0.2)", background: "rgba(74,222,128,0.03)", borderRadius: "10px", animation: "fadeInUp 0.4s ease both" }}>
                      <div style={{ display: "flex", alignItems: "center", gap: "8px", marginBottom: "12px" }}>
                        ...
                        <span style={{ fontSize: "10px", color: "#6B7C93" }}>{contentType} — {tone}</span>
                      </div>
              ...
              {mode === "sequence" && (
                <>
                  ...
                  <div style={{ display: "grid", gridTemplateColumns: isMobile ? "1fr" : "1fr 1fr", gap: "16px", marginBottom: "24px" }}>
                    ...
                    <div>
                      <label style={{ fontSize: "11px", letterSpacing: "2px", color: "#6B7C93", display: "block", marginBottom: "8px" }}>CIBLE / AUDIENCE</label>
                  ...
                  {/* Objective selector */}
                  <div style={{ marginBottom: "24px" }}>
                    <label style={{ fontSize: "11px", letterSpacing: "2px", color: "#6B7C93", display: "block", marginBottom: "10px" }}>OBJECTIF</label>
                    <div style={{ display: "flex", flexWrap: "wrap", gap: "8px" }}>
                      {OBJECTIVES.map(o => (
                  ...
                  <div style={{ marginBottom: "24px" }}>
                    <label style={{ fontSize: "11px", letterSpacing: "2px", color: "#6B7C93", display: "block", marginBottom: "10px" }}>NOMBRE D'EMAILS</label>
                  ...
                  <button onClick={generateSequence} disabled={eIsGenerating || !canGenerateSequence}
                    style={{
                      ...
                      border: "none", color: canGenerateSequence ? V : "#6B7C93", fontWeight: 700, fontSize: "12px",
                    ...
                    <div style={{ marginTop: "32px", position: "relative", paddingLeft: isMobile ? "24px" : "40px" }}>
                      ...
                      {sequence.map((email, i) => (
                        <div key={i} style={{
                          ...
                          {/* Timeline dot */}
                          <div style={{ position: "absolute", left: isMobile ? "-20px" : "-32px", top: "18px", width: "12px", height: "12px", borderRadius: "50%", background: "#FFFFFF", border: "2px solid #f43f5e", zIndex: 2 }} />
                          ...
                          <div style={{ padding: isMobile ? "16px" : "20px 24px", border: "1px solid rgba(244,63,94,0.2)", background: "rgba(244,63,94,0.03)", borderRadius: "10px" }}>
                            <div style={{ display: "flex", alignItems: "center", gap: "10px", marginBottom: "10px", flexWrap: "wrap" }}>
                              ...
                              <span style={{ fontSize: "10px", color: "#6B7C93", letterSpacing: "1px" }}>{email.delay}</span>
                            </div>
                            <div style={{ fontSize: "14px", fontWeight: 700, color: V2, marginBottom: "8px" }}>{email.subject}</div>
                            <p style={{ fontSize: "13px", color: "#6B7C93", lineHeight: 1.7, margin: 0 }}>{email.preview}</p>
                          </div>
                        </div>
                      ))}
                    </div>
                ...
                <>
                  ...
                  <button onClick={generateCalendar} disabled={fIsGenerating || !canGenerateCalendar}
                    style={{
                      ...
                      border: "none", color: canGenerateCalendar ? "#FFFFFF" : "#6B7C93", fontWeight: 700, fontSize: "12px",
      ...
      <footer style={{ padding: isMobile ? "30px 20px" : "40px 48px", borderTop: `1px solid ${VG(0.08)}`, display: "flex", justifyContent: "space-between", alignItems: "center", flexDirection: isMobile ? "column" : "row", gap: "12px" }}>
        ...
        <span style={{ fontSize: "11px", color: "#6B7C93" }}>NEXUS — Studio de Contenu IA</span>
      </footer>
    </div>
  );
}
