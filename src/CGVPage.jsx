  ...
  return (
    <main style={{ background: "#FFFFFF", color: "#0F172A", fontFamily: "'Inter', system-ui, -apple-system, sans-serif", minHeight: "100vh" }}>
      ...
      <div style={{ maxWidth: "800px", margin: "0 auto", padding: "60px 24px 80px" }}>
        <h1 style={{ fontSize: "28px", fontWeight: 800, letterSpacing: "-0.5px", marginBottom: "8px", color: "#0F172A" }}>Conditions Générales de Vente</h1>
        <div style={{ width: "40px", height: "2px", background: "#4F46E5", marginBottom: "40px" }} />

        <section style={{ marginBottom: "32px" }}>
          <h2 style={{ fontSize: "16px", fontWeight: 700, letterSpacing: "1px", textTransform: "uppercase", color: "#64748B", marginBottom: "16px" }}>1. Objet</h2>
          <p style={{ fontSize: "14px", lineHeight: 2, color: "#334155" }}>
        ...
        <section style={{ marginBottom: "32px" }}>
          <h2 style={{ fontSize: "16px", fontWeight: 700, letterSpacing: "1px", textTransform: "uppercase", color: "#64748B", marginBottom: "16px" }}>2. Prestations</h2>
          <div style={{ fontSize: "14px", lineHeight: 2, color: "#334155" }}>
        ...
        <section style={{ marginBottom: "32px" }}>
          <h2 style={{ fontSize: "16px", fontWeight: 700, letterSpacing: "1px", textTransform: "uppercase", color: "#64748B", marginBottom: "16px" }}>3. Abonnements et souscription</h2>
          <div style={{ fontSize: "14px", lineHeight: 2, color: "#334155" }}>
        ...
        <section style={{ marginBottom: "32px" }}>
          <h2 style={{ fontSize: "16px", fontWeight: 700, letterSpacing: "1px", textTransform: "uppercase", color: "#64748B", marginBottom: "16px" }}>4. Tarifs et paiement</h2>
          <div style={{ fontSize: "14px", lineHeight: 2, color: "#334155" }}>
        ...
        <section style={{ marginBottom: "32px" }}>
          <h2 style={{ fontSize: "16px", fontWeight: 700, letterSpacing: "1px", textTransform: "uppercase", color: "#64748B", marginBottom: "16px" }}>5. Délais</h2>
          <p style={{ fontSize: "14px", lineHeight: 2, color: "#334155" }}>
        ...
        <section style={{ marginBottom: "32px" }}>
          <h2 style={{ fontSize: "16px", fontWeight: 700, letterSpacing: "1px", textTransform: "uppercase", color: "#64748B", marginBottom: "16px" }}>6. Propriété intellectuelle</h2>
          <p style={{ fontSize: "14px", lineHeight: 2, color: "#334155" }}>
        ...
        <section style={{ marginBottom: "32px" }}>
          <h2 style={{ fontSize: "16px", fontWeight: 700, letterSpacing: "1px", textTransform: "uppercase", color: "#64748B", marginBottom: "16px" }}>7. Responsabilité</h2>
          <p style={{ fontSize: "14px", lineHeight: 2, color: "#334155" }}>
        ...
        <section style={{ marginBottom: "32px" }}>
          <h2 style={{ fontSize: "16px", fontWeight: 700, letterSpacing: "1px", textTransform: "uppercase", color: "#64748B", marginBottom: "16px" }}>8. Droit de rétractation</h2>
          <div style={{ fontSize: "14px", lineHeight: 2, color: "#334155" }}>
            <p>
        ...
        <section style={{ marginBottom: "32px" }}>
          <h2 style={{ fontSize: "16px", fontWeight: 700, letterSpacing: "1px", textTransform: "uppercase", color: "#64748B", marginBottom: "16px" }}>9. Résiliation</h2>
          <div style={{ fontSize: "14px", lineHeight: 2, color: "#334155" }}>
            <p>
        ...
        <section style={{ marginBottom: "32px" }}>
          <h2 style={{ fontSize: "16px", fontWeight: 700, letterSpacing: "1px", textTransform: "uppercase", color: "#64748B", marginBottom: "16px" }}>10. Médiateur de la consommation</h2>
          <div style={{ fontSize: "14px", lineHeight: 2, color: "#334155" }}>
            <p>
            ...
            <p>Site : medicys.fr</p>
            <p style={{ marginTop: "8px" }}>
              Plateforme européenne de règlement en ligne des litiges : <span style={{ color: "#4F46E5" }}>https://ec.europa.eu/consumers/odr</span>
            </p>
            <p style={{ marginTop: "8px" }}>
        ...
        <section style={{ marginBottom: "32px" }}>
          <h2 style={{ fontSize: "16px", fontWeight: 700, letterSpacing: "1px", textTransform: "uppercase", color: "#64748B", marginBottom: "16px" }}>11. Droit applicable et litiges</h2>
          <p style={{ fontSize: "14px", lineHeight: 2, color: "#334155" }}>
