  ...
  return (
    <div onMouseMove={handleMouseMove} style={{ background: "#09090B", color: "#FAFAFA", fontFamily: "'Helvetica Neue', Helvetica, Arial, sans-serif", minHeight: "100vh", position: "relative" }}>
      ...
      <style>{`
        ...
        .project-card:hover { transform: translateY(-8px); border-color: rgba(255,255,255,0.3) !important; }
        ...
        .chrome-btn-v:hover { transform: translateY(-2px); background: linear-gradient(135deg, #f0f0f0 0%, #c0c0c0 40%, #e0e0e0 60%, #b0b0b0 100%); box-shadow: inset 0 1px 0 rgba(255,255,255,0.6), inset 0 -1px 0 rgba(0,0,0,0.1), 0 6px 20px rgba(0,0,0,0.4); }
        .chrome-btn-v::before { content: ''; position: absolute; top: 0; left: -100%; width: 100%; height: 100%; background: linear-gradient(90deg, transparent, rgba(255,255,255,0.4), transparent); transition: left 0.5s ease; }
      ...
      <main style={{ padding: isMobile ? "100px 16px 60px" : "160px 48px 80px", maxWidth: "1200px", margin: "0 auto" }}>
        ...
        <section aria-label="Présentation Sites Vitrines" style={{ animation: "fadeInUp 0.6s ease both", marginBottom: isMobile ? "40px" : "64px" }}>
          ...
          <div style={{ display: "flex", flexDirection: isMobile ? "column" : "row", justifyContent: "space-between", alignItems: isMobile ? "flex-start" : "flex-end", gap: "20px" }}>
            ...
            <p style={{ fontSize: "15px", color: "#52525B", maxWidth: "400px", lineHeight: 1.8 }}>
            ...
            return (
              <div key={i} className="project-card"
                style={{
                  ...
                  border: `1px solid ${VG(0.1)}`, background: "rgba(24,24,27,0.4)", overflow: "hidden",
                ...
                <div style={{ padding: isMobile ? "28px 24px" : "40px 36px", display: "flex", flexDirection: "column", justifyContent: "center", direction: "ltr" }}>
                  ...
                  <p style={{ fontSize: "14px", color: "#71717A", lineHeight: 1.8, marginBottom: "20px" }}>
                    {project.description}
                  </p>
        ...
        {/* CTA */}
        <section aria-label="Appel à l'action" style={{ marginTop: "80px", textAlign: "center", padding: isMobile ? "40px 20px" : "60px 48px", border: `1px solid ${VG(0.1)}`, background: "rgba(24,24,27,0.3)", borderRadius: "12px", animation: "fadeInUp 0.8s ease 0.5s both" }}>
