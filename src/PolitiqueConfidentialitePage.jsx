  ...
  return (
    <main style={{ background: "#F0F1F3", color: "#0F172A", fontFamily: "'Inter', system-ui, -apple-system, sans-serif", minHeight: "100vh" }}>
      ...
      <div style={{ maxWidth: "800px", margin: "0 auto", padding: "60px 24px 80px" }}>
        ...
        <section style={{ marginBottom: "32px" }}>
          <h2 style={{ fontSize: "16px", fontWeight: 700, letterSpacing: "1px", textTransform: "uppercase", color: "#64748B", marginBottom: "16px" }}>2. Données collectées</h2>
          <div style={{ fontSize: "14px", lineHeight: 2, color: "#334155" }}>
        ...
        <section style={{ marginBottom: "32px" }}>
          <h2 style={{ fontSize: "16px", fontWeight: 700, letterSpacing: "1px", textTransform: "uppercase", color: "#64748B", marginBottom: "16px" }}>3. Finalités du traitement</h2>
          <div style={{ fontSize: "14px", lineHeight: 2, color: "#334155" }}>
        ...
        <section style={{ marginBottom: "32px" }}>
          <h2 style={{ fontSize: "16px", fontWeight: 700, letterSpacing: "1px", textTransform: "uppercase", color: "#64748B", marginBottom: "16px" }}>4. Base légale</h2>
        ...
        <section style={{ marginBottom: "32px" }}>
          <h2 style={{ fontSize: "16px", fontWeight: 700, letterSpacing: "1px", textTransform: "uppercase", color: "#64748B", marginBottom: "16px" }}>5. Durée de conservation</h2>
          <div style={{ fontSize: "14px", lineHeight: 2, color: "#334155" }}>
        ...
        <section style={{ marginBottom: "32px" }}>
          <h2 style={{ fontSize: "16px", fontWeight: 700, letterSpacing: "1px", textTransform: "uppercase", color: "#64748B", marginBottom: "16px" }}>6. Partage des données</h2>
          <div style={{ fontSize: "14px", lineHeight: 2, color: "#334155" }}>
        ...
        <section style={{ marginBottom: "32px" }}>
          <h2 style={{ fontSize: "16px", fontWeight: 700, letterSpacing: "1px", textTransform: "uppercase", color: "#64748B", marginBottom: "16px" }}>7. Vos droits</h2>
          <div style={{ fontSize: "14px", lineHeight: 2, color: "#334155" }}>
        ...
        <section style={{ marginBottom: "32px" }}>
          <h2 style={{ fontSize: "16px", fontWeight: 700, letterSpacing: "1px", textTransform: "uppercase", color: "#64748B", marginBottom: "16px" }}>8. Cookies</h2>
          <div style={{ fontSize: "14px", lineHeight: 2, color: "#334155" }}>
        ...
        <section style={{ marginBottom: "32px" }}>
          <h2 style={{ fontSize: "16px", fontWeight: 700, letterSpacing: "1px", textTransform: "uppercase", color: "#64748B", marginBottom: "16px" }}>9. Transferts de donn&eacute;es hors UE</h2>
          <p style={{ fontSize: "14px", lineHeight: 2, color: "#334155" }}>
