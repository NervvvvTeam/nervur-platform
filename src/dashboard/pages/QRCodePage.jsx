  ...
  return (
    <div style={{ maxWidth: "700px" }}>
      ...
      <div style={{ marginBottom: "32px" }}>
        ...
        <h1 style={{ fontSize: "22px", fontWeight: 600, color: "#0F172A", marginBottom: "6px" }}>QR Code Avis</h1>
        ...
        <div style={{
          ...
          {qrData?.qrCode ? (
            <>
              ...
              <p style={{ fontSize: "12px", color: "#334155", marginBottom: "20px", wordBreak: "break-all" }}>
                {qrData.reviewUrl}
              </p>
            ...
            <p style={{ color: "#334155", padding: "40px 0" }}>Génération du QR code...</p>
          )}
        </div>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: "18px" }}>
            {[
              ...
              <div key={i} style={{ display: "flex", gap: "14px", alignItems: "flex-start" }}>
                ...
                <div>
                  <div style={{ fontSize: "14px", fontWeight: 600, color: "#334155", marginBottom: "2px" }}>{item.title}</div>
      ...
      <div style={{
        ...
        <p style={{ fontSize: "15px", color: "#334155", lineHeight: 1.8, fontStyle: "italic" }}>
