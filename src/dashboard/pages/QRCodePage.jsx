  ...
  return (
    <div style={{ maxWidth: "700px" }}>
      ...
      <div style={{ marginBottom: "32px" }}>
        ...
        <h1 style={{ fontSize: "22px", fontWeight: 600, color: "#0A2540", marginBottom: "6px" }}>QR Code Avis</h1>
        ...
        <div style={{
          ...
          {qrData?.qrCode ? (
            <>
              ...
              <p style={{ fontSize: "12px", color: "#425466", marginBottom: "20px", wordBreak: "break-all" }}>
                {qrData.reviewUrl}
              </p>
            ...
            <p style={{ color: "#425466", padding: "40px 0" }}>Génération du QR code...</p>
          )}
        </div>
            ...
            {[
              ...
              <div key={i} style={{ display: "flex", gap: "14px", alignItems: "flex-start" }}>
                ...
                <div>
                  ...
                  <div style={{ fontSize: "13px", color: "#6B7C93", lineHeight: 1.5 }}>{item.desc}</div>
                </div>
              </div>
            ))}
          </div>
      ...
      <div style={{
        ...
        <p style={{ fontSize: "15px", color: "#425466", lineHeight: 1.8, fontStyle: "italic" }}>
