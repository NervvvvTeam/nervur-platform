  ...
  return (
    <div className="max-w-[1100px]">
      ...
      {!loading && !error && scans.length === 0 && (
        <div className="bg-[rgba(6,182,212,0.08)] border border-[rgba(6,182,212,0.2)] rounded-[10px] text-center px-6 py-12 shadow-[0_2px_8px_rgba(0,0,0,0.06)]">
          <ShieldIcon size={48} color="#AEAEB2" />
          ...
          {scans.map(scan => {
            ...
            return (
              <div
                ...
                className="bg-white rounded-[10px] p-6 shadow-[0_2px_8px_rgba(0,0,0,0.06)] cursor-pointer transition-all duration-150 flex items-center gap-4 hover:bg-[rgba(6,182,212,0.08)]"
                style={{
