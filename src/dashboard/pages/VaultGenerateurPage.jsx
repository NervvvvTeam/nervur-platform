        ...
        <div className="grid grid-cols-[repeat(auto-fill,minmax(200px,1fr))] gap-3">
          {DOC_TYPES.map(doc => (
            <button
              ...
              disabled={loading}
              className="bg-[#F8FAFC] rounded-[10px] px-5 py-4 shadow-[0_2px_8px_rgba(0,0,0,0.2)] text-left cursor-pointer font-[inherit] transition-all duration-150 hover:bg-[rgba(6,182,212,0.04)]"
              style={{
            ...
            >
              <div className="flex items-center gap-2 mb-2">
                ...
                <span className="text-sm font-semibold text-[#0F172A]">{doc.label}</span>
              </div>
