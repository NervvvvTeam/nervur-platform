...
const TrashIcon = ({ size = 15, color = "#86868B" }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round">
          ...
          <div className="flex flex-col gap-2.5">
            {configs.map(config => (
              <div key={config._id} className="px-[18px] py-4 rounded-lg transition-all duration-200" style={{
                ...
                border: `1px solid ${config.enabled ? BORDER_TINT : "#424245"}`,
                  ...
                  <div className="flex-1 min-w-[200px]">
                    <div className="flex items-center gap-2 mb-1.5">
                      ...
                      <span className="text-[10px] font-medium px-2 py-0.5 rounded-[10px]" style={{
                        ...
                        color: config.enabled ? ACCENT_LIGHT : "#86868B",
                      }}>
        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-4">
          ...
          <div>
            ...
            <input
              ...
              required
              className="w-full px-3.5 py-2.5 rounded-md bg-white border border-[rgba(6,182,212,0.2)] text-[#1D1D1F] text-[13px] font-[inherit] outline-none transition-colors duration-150 box-border focus:border-[#06b6d4]"
            />
          </div>
          ...
          <div>
            ...
            <textarea
              ...
              rows={4}
              required
              className="w-full px-3.5 py-2.5 rounded-md bg-white border border-[rgba(6,182,212,0.2)] text-[#1D1D1F] text-[13px] font-[inherit] outline-none resize-y transition-colors duration-150 box-border focus:border-[#06b6d4]"
            />
          </div>
          ...
          <div className="flex gap-4 flex-wrap">
            <div className="flex-1 min-w-[180px]">
              ...
              <select
                ...
                className="w-full px-3.5 py-2.5 rounded-md bg-white border border-[rgba(6,182,212,0.2)] text-[#1D1D1F] text-[13px] font-[inherit] outline-none cursor-pointer box-border"
              >
          ...
          <button
            ...
            style={{
              background: submitting ? "#E5E5EA" : `linear-gradient(135deg, ${ACCENT}, ${ACCENT_LIGHT})`,
