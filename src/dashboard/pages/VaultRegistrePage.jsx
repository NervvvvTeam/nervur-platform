    ...
    <div className="max-w-[1100px]">
      ...
      {showForm && (
        <div className="bg-white border border-[rgba(6,182,212,0.2)] rounded-[10px] p-6 shadow-[0_2px_8px_rgba(0,0,0,0.06)] mb-7">
          <h2 className="text-[15px] font-semibold text-[#1D1D1F] m-0 mb-5">
                ...
                return (
                  <button
                    ...
                    style={{
                      ...
                      borderColor: selected ? "#06b6d4" : "#E5E5EA",
                      color: selected ? "#22d3ee" : "#86868B",
                    }}
                  >
                    {selected ? "\u2713 " : ""}{cat.label}
                  </button>
          ...
          <div className="flex gap-3">
            <button
              ...
              className="inline-flex items-center gap-2 px-5 py-2.5 rounded-lg border-none text-sm font-semibold font-[inherit] transition-all duration-150 cursor-pointer"
              style={{
                background: saving ? "#E5E5EA" : "linear-gradient(135deg, #06b6d4, #22d3ee)",
                color: saving ? "#86868B" : "#0f0f11",
            ...
            <button
              ...
              className="px-4 py-2.5 rounded-lg border border-[#E5E5EA] bg-transparent text-[#9ca3af] text-sm cursor-pointer font-[inherit] transition-all duration-150 hover:border-[#D1D1D6] hover:text-[#d1d5db]"
            >
              Annuler
            </button>
          </div>
