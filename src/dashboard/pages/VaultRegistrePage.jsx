...
export default function VaultRegistrePage() {
  ...
  const inputStyle = "w-full px-3.5 py-2.5 bg-white border border-[#E3E8EE] rounded-lg text-[#425466] text-sm font-[inherit] outline-none transition-colors duration-150 box-border focus:border-[#06b6d4]";
    ...
    <div className="max-w-[1100px]">
      ...
      {showForm && (
        <div className="bg-white border border-[rgba(6,182,212,0.2)] rounded-[10px] p-6 shadow-[0_2px_8px_rgba(0,0,0,0.06)] mb-7">
          <h2 className="text-[15px] font-semibold text-[#0A2540] m-0 mb-5">
                ...
                return (
                  <button
                    ...
                    style={{
                      ...
                      borderColor: selected ? "#06b6d4" : "#E3E8EE",
                      color: selected ? "#22d3ee" : "#6B7C93",
                    }}
                  >
                    {selected ? "\u2713 " : ""}{cat.label}
                  </button>
          ...
          <div className="flex gap-3">
            <button
              ...
              className="inline-flex items-center gap-2 px-5 py-2.5 rounded-lg border-none text-sm font-semibold font-[inherit] transition-all duration-150 cursor-pointer"
              style={{
                background: saving ? "#E3E8EE" : "linear-gradient(135deg, #06b6d4, #22d3ee)",
                color: saving ? "#6B7C93" : "#0f0f11",
            ...
            <button
              ...
              className="px-4 py-2.5 rounded-lg border border-[#E3E8EE] bg-transparent text-[#9ca3af] text-sm cursor-pointer font-[inherit] transition-all duration-150 hover:border-[#E3E8EE] hover:text-[#d1d5db]"
            >
              Annuler
            </button>
          </div>
      ...
      {!loading && treatments.length > 0 && (
        <div className="flex flex-col gap-3">
          {treatments.map(t => (
            <div key={t._id} className="bg-white border border-[rgba(6,182,212,0.15)] rounded-[10px] p-5 shadow-[0_2px_8px_rgba(0,0,0,0.06)]">
              <div className="flex items-start justify-between gap-3 mb-3">
                <div>
                  <div className="text-[15px] font-semibold text-[#0A2540]">{t.name}</div>
