    ...
    <div style={{ maxWidth: "1100px" }}>
      ...
      <div style={{
        ...
        <div style={{ marginBottom: "18px" }}>
          <div style={{ fontSize: "12px", color: "#64748B", marginBottom: "8px", fontWeight: 500 }}>Objectif</div>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(200px, 1fr))", gap: "14px", marginBottom: "18px" }}>
          <div>
            <div style={{ fontSize: "12px", color: "#64748B", marginBottom: "8px", fontWeight: 500 }}>Entreprise</div>
          ...
          <div>
            <div style={{ fontSize: "12px", color: "#64748B", marginBottom: "8px", fontWeight: 500 }}>Audience cible</div>
        ...
        <div>
          {result.summary && (
            <div style={{
              ...
              <p style={{ fontSize: "14px", color: "#334155", lineHeight: 1.6, margin: 0 }}>{result.summary}</p>
            </div>
          )}
              ...
              <div key={i} style={{
                ...
                <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: "12px" }}>
                  <div style={{ display: "flex", alignItems: "center", gap: "10px" }}>
                    ...
                    <span style={{ fontSize: "13px", color: "#64748B" }}>Email {i + 1}/{result.sequence.length}</span>
                  </div>
                ...
                <div style={{
                  fontSize: "14px", color: "#64748B", lineHeight: 1.7, whiteSpace: "pre-wrap",
                  marginBottom: "10px",
                }}>
                  {email.body}
                </div>
