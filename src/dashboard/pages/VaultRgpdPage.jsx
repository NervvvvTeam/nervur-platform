...
const ClockIcon = ({ size = 14, color = "#6B7C93" }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
    ...
    <div className="max-w-[1100px]">
      ...
      <div className="px-5 py-4 bg-[rgba(6,182,212,0.06)] border border-[rgba(6,182,212,0.2)] border-l-[3px] border-l-[#06b6d4] rounded-[10px] mb-7 flex items-start gap-3.5">
        ...
        <div className="text-[13px] text-[#d1d5db] leading-[1.7]">
          <strong className="text-[#0A2540]">Vault — Scan RGPD</strong>
          <br />
          ...
          {scan.aiRecommendations && (
            <div className="mb-6">
              <div className="flex items-center gap-2 mb-3.5">
                <ShieldIcon size={18} color={ACCENT} />
                <h3 className="text-base font-semibold text-[#0A2540] m-0">
                  Recommandations IA
                </h3>
              </div>
                ...
                {actionPlanItems.map((item, i) => (
                  <div key={item.key} className="px-6 py-5" style={{
                    ...
                    <div className="flex items-start gap-3.5">
                      ...
                      <div className="flex-1">
                        {/* Issue title */}
                        <div className="text-sm font-semibold text-[#0A2540] mb-2">
                          {item.issue}
                        </div>
                        ...
                        <div className="inline-flex items-center gap-1.5 text-[11px] text-[#9ca3af]">
                          <ClockIcon size={12} color="#6B7C93" />
      ...
      <div className="mt-4">
        <div className="flex items-center gap-2 mb-3.5">
          <ClockIcon size={16} color="#6B7C93" />
        ...
        {!loadingHistory && history.length === 0 && (
          <div className="bg-white border border-[#E3E8EE] rounded-[10px] px-6 py-8 shadow-[0_2px_8px_rgba(0,0,0,0.06)] text-center text-[#6b7280] text-[13px]">
