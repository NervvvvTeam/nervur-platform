        ...
        <>
          ...
          <div style={{
            ...
            <button
              ...
              style={{
                padding: "10px 24px",
                background: loadingSuggestions ? "#E5E5EA" : "linear-gradient(135deg, #f59e0b, #fbbf24)",
                color: loadingSuggestions ? "#86868B" : "#FFFFFF",
                    ...
                    {suggestions.map((sug, i) => {
                      ...
                      return (
                        <tr key={i} style={{ borderBottom: "1px solid #2a2d3a20" }}>
                          <td style={{ padding: "14px 24px", color: "#1D1D1F", fontSize: "13px", fontWeight: 500 }}>
                            {keywordStr}
                          </td>
                          <td style={{ padding: "14px 24px", color: "#424245", fontSize: "13px" }}>
