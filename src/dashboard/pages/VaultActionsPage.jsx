...
const CATEGORY_COLORS = {
  ...
  Autre: { bg: "rgba(107,114,128,0.12)", text: "#6B7C93" },
};

const SEVERITY_MAP = {
  1: { label: "Négligeable", color: "#6B7C93", bg: "rgba(107,114,128,0.15)" },
...
const GripIcon = ({ size = 14, color = "#6B7C93" }) => (
...
const ClockIcon = ({ size = 12, color = "#6B7C93" }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
    <circle cx="12" cy="12" r="10" /><polyline points="12 6 12 12 16 14" />
  </svg>
);

const PencilIcon = ({ size = 13, color = "#6B7C93" }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
...
const PlusIcon = ({ size = 14, color = "#6B7C93" }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth="2.5" strokeLinecap="round">
    <line x1="12" y1="5" x2="12" y2="19" /><line x1="5" y1="12" x2="19" y2="12" />
  </svg>
);

const XIcon = ({ size = 13, color = "#6B7C93" }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth="2.5" strokeLinecap="round">
    <line x1="18" y1="6" x2="6" y2="18" /><line x1="6" y1="6" x2="18" y2="18" />
  </svg>
);

const ArrowLeftIcon = ({ size = 12, color = "#6B7C93" }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round">
    <line x1="19" y1="12" x2="5" y2="12" /><polyline points="12 19 5 12 12 5" />
  </svg>
);

const ArrowRightIcon = ({ size = 12, color = "#6B7C93" }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round">
...
function Modal({ open, onClose, title, children }) {
  ...
  return (
    ...
    >
      ...
      >
        <h3 style={{ margin: "0 0 18px 0", fontSize: 16, fontWeight: 600, color: "#0A2540" }}>
          {title}
        </h3>
        {children}
      </div>
...
function ActionCard({ action, columns, onMove, onEdit, onDelete }) {
  ...
  const catStyle = CATEGORY_COLORS[action.category] || { bg: "rgba(107,114,128,0.12)", text: "#6B7C93" };
  ...
  return (
    ...
    >
      ...
      <div style={{ display: "flex", alignItems: "center", gap: 4, marginTop: 8, marginLeft: 22 }}>
        ...
        >
          <ArrowLeftIcon size={12} color={canLeft ? ACCENT : "#6B7C93"} />
        </button>
        <button
        ...
        >
          <ArrowRightIcon size={12} color={canRight ? ACCENT : "#6B7C93"} />
        </button>
        <div style={{ flex: 1 }} />
        <button
          style={iconBtn}
        ...
        >
          <PencilIcon size={13} color="#6B7C93" />
        </button>
        <button
          style={iconBtn}
    ...
    <div className="max-w-[1100px]">
      ...
      <div className="grid grid-cols-4 gap-3 mb-4" style={{ fontSize: 13 }}>
        <div style={cardStyle}>
          ...
          <p className="text-[22px] font-bold text-[#0A2540] m-0">{totalActions}</p>
        </div>
        <div style={cardStyle}>
              ...
              <table style={{ width: "100%", borderCollapse: "collapse" }}>
                ...
                <tbody>
                  {incidents.map((inc) => {
                    ...
                    const statusStyle = INCIDENT_STATUS_COLORS[inc.status] || { bg: "rgba(107,114,128,0.12)", text: "#6B7C93" };
                    ...
                    return (
                      <tr key={inc.id} style={{ borderBottom: "1px solid #2a2d3a" }} className="hover:bg-[rgba(255,255,255,0.02)] transition-colors">
                        <td style={{ padding: "12px 10px", fontSize: 13, color: "#6B7C93", whiteSpace: "nowrap" }}>
                        ...
                        <td style={{ padding: "12px 10px", fontSize: 12, color: "#6B7C93", maxWidth: 140 }}>
                          <div style={{ overflow: "hidden", textOverflow: "ellipsis", whiteSpace: "nowrap" }}>
                            {inc.dataTypes}
                          </div>
                        </td>
                  ...
                  {incidents.length === 0 && (
                    <tr>
                      <td colSpan={8} style={{ padding: "30px 10px", textAlign: "center", fontSize: 13, color: "#6B7C93" }}>
                ...
                <span key={step} className="flex items-center gap-1.5">
                  <span
                    style={{
                      fontSize: 11,
                      fontWeight: 500,
                      color: i === arr.length - 1 ? "#22c55e" : "#6B7C93",
