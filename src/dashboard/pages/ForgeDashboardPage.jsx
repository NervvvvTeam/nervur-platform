  ...
  return (
    <div style={{ maxWidth: "1100px" }}>
      ...
      <div style={{ marginBottom: "32px" }}>
        ...
        <h1 style={{ fontSize: "22px", fontWeight: 600, color: "#0A2540", margin: 0, marginBottom: "6px" }}>
      ...
      {result ? (
        <div>
          ...
          <div style={{
            ...
            <div>
              <h2 style={{ fontSize: "16px", fontWeight: 600, color: "#0A2540", margin: 0 }}>
                {result.businessName || "Landing Page"}
              </h2>
              <p style={{ fontSize: "13px", color: "#6B7C93", margin: "4px 0 0" }}>
            ...
            <div style={{ display: "flex", gap: "10px", flexWrap: "wrap" }}>
              ...
              <button
                ...
                style={{
                  padding: "9px 18px", borderRadius: "8px", fontSize: "13px", fontWeight: 500,
                  background: "transparent", color: copied ? "#10b981" : "#6B7C93",
              ...
              <button
                ...
                onMouseEnter={(e) => { e.target.style.borderColor = "#8898AA"; e.target.style.color = "#6B7C93"; }}
                onMouseLeave={(e) => { e.target.style.borderColor = "#1e1e22"; e.target.style.color = "#6B7C93"; }}
              >
                Nouvelle page
              </button>
            </div>
          ...
          <div style={{
            ...
            <div style={{
              ...
              <span style={{ fontSize: "12px", color: "#6B7C93", marginLeft: "8px" }}>
          ...
          <div style={{ marginTop: "28px" }}>
            <button
              ...
              style={{
                ...
                fontSize: "14px",
                fontWeight: 600,
                background: loading ? "#6B7C93" : "linear-gradient(135deg, #f59e0b, #fbbf24)",
                color: loading ? "#6B7C93" : "#000",
                border: "none",
