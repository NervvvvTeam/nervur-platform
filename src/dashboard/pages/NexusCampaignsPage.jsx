...
export default function NexusCampaignsPage() {
  ...
  return (
    <div style={{ maxWidth: "1100px" }}>
      ...
      {/* Create campaign */}
      {showCreate && (
        <div style={{ padding: "24px", background: "#E8E9EC", border: "1px solid #2a2d3a", borderRadius: "10px", boxShadow: "0 2px 8px rgba(0,0,0,0.2)", marginBottom: "24px" }}>
            ...
            <>
              ...
              <div style={{ marginBottom: "14px" }}>
                ...
                <textarea value={editHtml} onChange={e => setEditHtml(e.target.value)} rows={8}
                  style={{ width: "100%", padding: "12px 14px", background: "#E8E9EC", border: "1px solid #2a2d3a", borderRadius: "8px", color: "#64748B", fontSize: "12px", fontFamily: "monospace", outline: "none", boxSizing: "border-box", resize: "vertical", transition: "border-color 0.2s" }}
                  onFocus={e => e.target.style.borderColor = "#10b981"}
                  onBlur={e => e.target.style.borderColor = "#E2E8F0"} />
              </div>
      ...
      {loading ? (
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: "10px" }}>
          {campaigns.map(c => (
            <div key={c._id} style={{
              padding: "20px 24px", background: "#E8E9EC", border: "1px solid #2a2d3a", borderRadius: "10px", boxShadow: "0 2px 8px rgba(0,0,0,0.2)",
              ...
              {c.status === "sent" && (
                <div style={{ display: "grid", gridTemplateColumns: "repeat(4, 1fr)", gap: "12px", marginBottom: "12px" }}>
                  {[
                    ...
                    <div key={s.label} style={{ padding: "10px 14px", background: "#E8E9EC", borderRadius: "6px", border: "1px solid #2a2d3a" }}>
