  ...
  return (
    <div style={{ maxWidth: "1100px" }}>
      ...
      <div style={{
        ...
        {loading ? (
          <div style={{ padding: "20px 0", textAlign: "center", color: "#86868B", fontSize: "14px" }}>
            Chargement...
          </div>
        ) : domains.length === 0 ? (
          <div style={{ padding: "20px 0", textAlign: "center", color: "#86868B", fontSize: "13px" }}>
          ...
          <div style={{ display: "flex", gap: "12px", alignItems: "flex-end", flexWrap: "wrap" }}>
            ...
            <button
              ...
              style={{
                padding: "10px 24px",
                background: selectedDomain ? "linear-gradient(135deg, #8b5cf6, #a78bfa)" : "#E5E5EA",
      ...
      <div style={{
        ...
        {schedules.length === 0 ? (
          <div style={{ padding: "48px 24px", textAlign: "center" }}>
            <svg width="40" height="40" viewBox="0 0 24 24" fill="none" stroke="#E5E5EA" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" style={{ marginBottom: "12px" }}>
            ...
            {schedules.map((schedule, idx) => (
              <div key={schedule._id || schedule.id} style={{
                ...
                <div style={{ display: "flex", alignItems: "center", gap: "14px" }}>
                  ...
                  <div>
                    <div style={{ fontSize: "14px", fontWeight: 500, color: "#424245" }}>
                      {schedule.domain}
                    </div>
                    <div style={{ fontSize: "12px", color: "#86868B" }}>
                ...
                <div style={{ display: "flex", alignItems: "center", gap: "12px" }}>
                  <span style={{
                    ...
                    color: schedule.enabled ? "#10b981" : "#86868B",
                  }}>
                  ...
                  <button
                    ...
                    style={{
                      ...
                      background: schedule.enabled ? "#8b5cf6" : "#E5E5EA",
