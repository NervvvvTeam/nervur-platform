      ...
      <div style={{ display: "flex", gap: "16px", flexWrap: "wrap" }}>
        {segments.map((seg, i) => (
          <div key={i} style={{ display: "flex", alignItems: "center", gap: "6px" }}>
            ...
            <span style={{ fontSize: "11px", color: "#86868B" }}>{seg.label}: <span style={{ color: seg.color, fontWeight: 600 }}>{seg.count}</span> ({seg.pct}%)</span>
          </div>
        ))}
      </div>
    </div>
...
function KeywordMovers({ rankings, type = "best" }) {
  ...
  if (sorted.length === 0) {
    return (
      <div style={{ textAlign: "center", padding: "20px 0", color: "#86868B", fontSize: "12px" }}>
      ...
      {sorted.map((r, i) => (
        <div key={i} style={{
          ...
          <div style={{ display: "flex", alignItems: "center", gap: "10px", flex: 1, minWidth: 0 }}>
            ...
            <span style={{ color: "#1D1D1F", fontSize: "13px", fontWeight: 500, overflow: "hidden", textOverflow: "ellipsis", whiteSpace: "nowrap" }}>
              {r.keyword}
            </span>
          </div>
    ...
    <div>
      ...
      {loading ? (
        ...
        <div style={{
          ...
          <p style={{ color: "#86868B", fontSize: "13px", margin: 0 }}>Creez un projet dans l'onglet Projets pour voir son evolution.</p>
        </div>
      ) : (
        <>
          {/* Project Selector */}
          <div style={{ marginBottom: "24px" }}>
            <label style={{ display: "block", fontSize: "12px", color: "#86868B", marginBottom: "8px" }}>Projet</label>
            <select
          ...
          {rankings.length > 0 && (
            <div style={{
              ...
              <h3 style={{ color: "#1D1D1F", fontSize: "14px", fontWeight: 600, margin: "0 0 16px" }}>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(320px, 1fr))", gap: "20px", marginBottom: "24px" }}>
            ...
            <div style={{
              ...
              <div style={{ textAlign: "center", marginTop: "8px", fontSize: "11px", color: "#86868B" }}>
          ...
          {rankings.length > 0 && (
            <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(300px, 1fr))", gap: "20px", marginBottom: "24px" }}>
              ...
              <div style={{
                ...
                <h3 style={{ color: "#1D1D1F", fontSize: "14px", fontWeight: 600, margin: "0 0 16px", display: "flex", alignItems: "center", gap: "8px" }}>
          ...
          <div style={{
            ...
            <div style={{ padding: "16px 24px", borderBottom: "1px solid #2a2d3a" }}>
              <h3 style={{ color: "#1D1D1F", fontSize: "14px", fontWeight: 600, margin: 0 }}>Historique des verifications</h3>
            </div>
            {history.length === 0 ? (
              <div style={{ padding: "40px 24px", textAlign: "center", color: "#86868B", fontSize: "13px" }}>
                  ...
                  <tbody>
                    {[...history].reverse().map((h, i) => (
                      <tr key={i} style={{ borderBottom: "1px solid #2a2d3a20" }}>
                        <td style={{ padding: "12px 24px", color: "#424245", fontSize: "13px" }}>
                        ...
                        <td style={{ padding: "12px 24px", color: "#86868B", fontSize: "13px" }}>
                          {h.keywordCount}
                        </td>
