  ...
  return (
    <div className="relative" style={{ width: size, height: size }}>
      <svg width={size} height={size} style={{ transform: "rotate(-90deg)" }}>
        <circle cx={size / 2} cy={size / 2} r={radius} fill="none" stroke="#E3E8EE" strokeWidth="6" />
...
function Chip({ label, color = "#6B7C93" }) {
  return (
    <span
...
function MiniResponseTimeChart({ history, width = 260, height = 60 }) {
  ...
  return (
    <svg width={width} height={height} className="block">
      ...
      {points.map((p, i) => (
        <circle key={i} cx={getX(i)} cy={getY(p.responseTime || 0)} r="3" fill={ACCENT} stroke="#FFFFFF" strokeWidth="1.5" />
      ))}
    </svg>
  );
}
...
function AlertsConfig({ site, onSave }) {
  ...
  return (
    <div className="mt-4 p-4 bg-white border border-[#E3E8EE] rounded-lg border-l-[3px] border-l-[#ec4899]">
      <div className="flex items-center gap-2 mb-3.5">
        <BellIcon size={16} color={ACCENT} />
        <span className="text-[13px] font-semibold text-[#0A2540]">Configurer les alertes</span>
      </div>
      ...
      <div className="mb-3">
        ...
        <input
          ...
          className="w-full px-3 py-2 bg-white border border-[#E3E8EE] rounded-md text-[#0A2540] text-[13px] font-[inherit] outline-none box-border"
        />
      </div>
        ...
        {[
          ...
          <div key={label} className="flex items-center justify-between">
            ...
            <button
              ...
              style={{ background: active ? ACCENT : "#E3E8EE" }}
            >
              <div
...
function StatusPagePreview({ site, statusData, onClose }) {
  ...
  return (
    ...
    >
      <div
        className="w-[600px] max-h-[80vh] overflow-auto bg-white rounded-xl border border-[#E3E8EE] p-8"
      ...
      >
        ...
        <div className="text-center mb-7">
          <div className="flex items-center justify-center gap-2.5 mb-2">
            ...
            <h2 className="text-xl font-bold text-[#0A2540] m-0">
              {statusData.domain}
            </h2>
          </div>
...
function SiteCard({ site, onRecheck, onDelete, onSaveAlerts, onShowStatusPage, recheckingId }) {
  ...
  return (
    <div className="bg-[rgba(236,72,153,0.06)] border border-[rgba(236,72,153,0.18)] rounded-[10px] p-6 shadow-[0_2px_8px_rgba(0,0,0,0.06)] mb-3">
      {/* Header row */}
      <div
      ...
      >
        <div className="flex items-center gap-4">
          ...
          <div>
            <div className="text-base font-semibold text-[#0A2540]">{site.domain}</div>
        ...
        <div className="flex items-center gap-2">
          ...
          <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="#6B7C93" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"
      ...
      {expanded && (
        <div className="mt-5 pt-5 border-t border-[rgba(236,72,153,0.18)]">
          ...
          <div className="grid grid-cols-2 gap-3">
            ...
            <div className="p-4 bg-white border border-[#E3E8EE] rounded-lg" style={{ borderLeft: `3px solid ${check.uptime?.status ? "#10b981" : "#ef4444"}` }}>
            ...
            <div className="p-4 bg-white border border-[#E3E8EE] rounded-lg" style={{ borderLeft: `3px solid ${sslColor}` }}>
            ...
            {/* Domain card */}
            <div className="p-4 bg-white border border-[#E3E8EE] rounded-lg" style={{ borderLeft: `3px solid ${domainColor}` }}>
            ...
            {/* DNS card with chips */}
            <div className="p-4 bg-white border border-[#E3E8EE] rounded-lg" style={{ borderLeft: `3px solid ${check.dns?.aRecords ? "#10b981" : "#ef4444"}` }}>
          ...
          <div className="mt-3 p-4 bg-white border border-[#E3E8EE] rounded-lg border-l-[3px] border-l-[#ec4899]">
          ...
          {/* HTTP/2 */}
          {check.http2 && (
            <div className="mt-3 px-4 py-3 bg-white border border-[#E3E8EE] rounded-lg flex items-center justify-between">
  ...
  return (
    <div className="max-w-[1100px]">
      ...
      <div className="flex items-center gap-3.5 mb-2">
        ...
        <div>
          <h1 className="text-[22px] font-semibold text-[#0A2540] m-0">Pulse</h1>
      ...
      {/* Add site form */}
      <div className="bg-white border border-[rgba(236,72,153,0.18)] rounded-[10px] p-6 shadow-[0_2px_8px_rgba(0,0,0,0.06)] mb-7">
        ...
        <div className="flex gap-2.5">
          <input
            ...
            className="flex-1 px-4 py-3 bg-white border border-[#E3E8EE] rounded-lg text-[#0A2540] text-sm font-[inherit] outline-none box-border transition-[border-color,box-shadow] duration-200 focus:border-[#ec4899] focus:shadow-[0_0_0_3px_rgba(236,72,153,0.18)]"
          />
          <button
            onClick={addSite}
