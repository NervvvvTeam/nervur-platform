    ...
    <div style={{ maxWidth: "1100px" }}>
      ...
      <div style={{
        ...
        <div style={{ marginBottom: "16px" }}>
          ...
          {loadingDomains ? (
            <div style={{ color: "#86868B", fontSize: "13px" }}>Chargement...</div>
          ) : domains.length > 0 ? (
            <select
              value={yourDomain}
        ...
        <button
          ...
          style={{
            padding: "10px 28px",
            background: loading ? "#E5E5EA" : "linear-gradient(135deg, #8b5cf6, #a78bfa)",
      ...
      {results && (
        <div style={{
          ...
          <div style={{ overflowX: "auto" }}>
            <table style={{ width: "100%", borderCollapse: "collapse" }}>
              <thead>
                <tr>
                  <th style={{
                    textAlign: "left", padding: "12px 16px", color: "#86868B",
                  ...
                  {results.competitors.map((comp, i) => (
                    <th key={i} style={{
                      textAlign: "center", padding: "12px 16px", color: "#86868B",
                      fontWeight: 500, fontSize: "12px", borderBottom: "1px solid #2a2d3a",
                    }}>
                      {comp.domain}
                      {!comp.success && (
              ...
              <tbody>
                {SCORE_KEYS.map(({ key, label }) => (
                  <tr key={key} style={{ borderBottom: "1px solid #2a2d3a20" }}>
                    <td style={{
                      padding: "12px 16px", fontSize: "13px", fontWeight: 500, color: "#424245",
                    }}>
                      {label}
                    </td>
          ...
          <div style={{
            ...
            <div style={{ fontSize: "12px", color: "#86868B", marginBottom: "8px" }}>Résumé</div>
            {(() => {
