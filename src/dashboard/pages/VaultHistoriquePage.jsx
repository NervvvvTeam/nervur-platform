...
const GlobeIcon = ({ size = 16, color = "#86868B" }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round">
  ...
  return (
    <div className="max-w-[1100px]">
      ...
      {!loading && history.length === 0 && (
        <div className="bg-white border border-[#E5E5EA] rounded-[10px] px-6 py-10 shadow-[0_2px_8px_rgba(0,0,0,0.06)] text-center">
          <ClockIcon size={40} color="#86868B" />
          ...
          {Object.entries(domainGroups).map(([domain, scans]) => (
            <div key={domain}>
              <div className="flex items-center gap-2 mb-3">
                ...
                <h3 className="text-[15px] font-semibold text-[#1D1D1F] m-0">{domain}</h3>
              ...
              <div className="flex flex-col gap-2">
                {scans.map(scan => (
                  <div
                    ...
                    className="bg-white rounded-[10px] px-[18px] py-3.5 shadow-[0_2px_8px_rgba(0,0,0,0.06)] cursor-pointer transition-all duration-150 flex items-center justify-between border border-[#E5E5EA] hover:border-[rgba(6,182,212,0.3)] hover:bg-[rgba(6,182,212,0.04)]"
                  >
        ...
        {!docsLoading && documents.length > 0 && (
          <div className="flex flex-col gap-3">
            {documents.map((doc) => (
              <div
                key={doc.id || doc._id}
                className="bg-white rounded-[10px] px-5 py-4 shadow-[0_2px_8px_rgba(0,0,0,0.06)] border border-[#E5E5EA] hover:border-[rgba(6,182,212,0.25)] transition-all duration-150 flex items-center justify-between"
              >
                ...
                <div className="flex items-center gap-2">
                  <button
                    ...
                    onMouseEnter={(e) => { e.currentTarget.style.borderColor = "rgba(6,182,212,0.3)"; e.currentTarget.style.color = "#1D1D1F"; }}
                    onMouseLeave={(e) => { e.currentTarget.style.borderColor = "rgba(0,0,0,0.08)"; e.currentTarget.style.color = "#86868B"; }}
                  >
                    Voir
                  </button>
                  <button
