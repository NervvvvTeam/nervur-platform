...
export default function SentinelPage() {
  ...
  return (
    <div onMouseMove={handleMouseMove} className="bg-white text-[#0A2540] font-[Helvetica_Neue,Helvetica,Arial,sans-serif] min-h-screen relative" role="document">
      ...
      <main className="mx-auto max-w-[1100px]" style={{ padding: isMobile ? "100px 20px 60px" : "160px 48px 80px" }}>
        {/* RETOUR */}
        <div className="mb-5">
          <button onClick={() => navigate("/")} className="bg-transparent border border-white/15 rounded-lg text-[#6B7C93] text-[13px] px-5 py-2 cursor-pointer font-[inherit] transition-all duration-300"
        ...
        <div className="mb-10" style={{ animation: "fadeInUp 0.8s ease both" }}>
          ...
          <p className="text-lg text-[#6B7C93] leading-[1.8] max-w-[680px]">
        ...
        <section aria-label="Statistiques clés" className="grid gap-3 mb-8" style={{ gridTemplateColumns: isMobile ? "1fr 1fr" : "repeat(6, 1fr)", animation: "fadeInUp 0.8s ease 0.2s both" }}>
          {[
            ...
            <div key={i} className="py-4 px-3 bg-[rgba(255,255,255,0.7)] text-center" style={{ border: `1px solid ${VG(0.1)}` }}>
              ...
              <div className="text-[8px] tracking-[1.5px] uppercase text-[#6B7C93]">{s.label}</div>
            </div>
          ))}
        </section>
        ...
        <div className="flex gap-2 mb-8 flex-wrap" style={{ animation: "fadeInUp 0.8s ease 0.3s both" }}>
          {TABS.map(tab => (
            <button key={tab.key} onClick={() => setActiveTab(tab.key)} className="text-[11px] tracking-[1.5px] uppercase font-bold cursor-pointer font-[inherit] transition-all duration-300" style={{
              ...
              color: activeTab === tab.key ? tab.color : "#6B7C93",
            }}>{tab.label}</button>
          ))}
        </div>
            ...
            <div className="rounded-xl overflow-hidden backdrop-blur-[12px]" style={{ border: `1px solid ${VG(0.1)}`, background: "rgba(255,255,255,0.75)" }}>
              ...
              <div className="flex items-center justify-between" style={{ padding: "14px 20px", borderBottom: `1px solid ${VG(0.08)}` }}>
                <div className="flex gap-1.5 items-center">
                  ...
                  <span className="text-[11px] text-[#6B7C93] ml-3 tracking-[1px]">sentinel-dashboard.nervur.com</span>
                </div>
              ...
              <div style={{ padding: isMobile ? "20px" : "32px" }}>
                ...
                <div className="grid gap-4 mb-7" style={{ gridTemplateColumns: isMobile ? "1fr" : "1fr 1fr 1fr" }}>
                  <div className="p-4 rounded-lg text-center" style={{ border: `1px solid ${VG(0.08)}`, background: VG(0.02) }}>
                    ...
                    <div className="text-[9px] text-[#6B7C93] tracking-[1.5px] uppercase">Score global</div>
                  ...
                  <div className="p-4 rounded-lg text-center" style={{ border: `1px solid ${VG(0.08)}`, background: VG(0.02) }}>
                    ...
                    <div className="text-[9px] text-[#6B7C93] tracking-[1.5px] uppercase">Alertes cette semaine</div>
                  ...
                  <div className="p-4 rounded-lg text-center" style={{ border: `1px solid ${VG(0.08)}`, background: VG(0.02) }}>
                    ...
                    <div className="text-[9px] text-[#6B7C93] tracking-[1.5px] uppercase">Évolution ce mois</div>
                ...
                <div className="mb-7">
                  <div className="flex items-center justify-between mb-3.5">
                    <h3 className="text-xs font-bold text-[#6B7C93] tracking-[1.5px] uppercase">Flux d'avis en temps réel</h3>
                    <span className="text-[9px] text-[#6B7C93] tracking-[1px]">{FAKE_REVIEWS.length} NOUVEAUX</span>
                  </div>
                    ...
                    {FAKE_REVIEWS.map((review, i) => (
                      <div key={i} onClick={() => { setSelectedReview(i); setUserReview(review.text); }}
                        ...
                        <div className="flex justify-between items-center mb-1.5 flex-wrap gap-1.5">
                          ...
                          <div className="flex items-center gap-2">
                            <span className="text-[9px] text-[#6B7C93] tracking-[0.5px]">{review.source}</span>
                            <span className="text-[9px] text-[#3f3f46]">{review.date}</span>
                          </div>
                        </div>
                        <p className="text-[13px] text-[#6B7C93] leading-[1.6] m-0">{review.text}</p>
                      </div>
                    ))}
                  </div>
                </div>
                ...
                <div className="rounded-[10px]" style={{ padding: isMobile ? "20px" : "24px", border: `1px solid ${VG(0.12)}`, background: "rgba(239,68,68,0.02)" }}>
                  ...
                  <button onClick={() => generateResponse(userReview)}
                    ...
                    className="mt-3 font-bold text-xs tracking-[1.5px] uppercase font-[inherit] transition-all duration-300" style={{
                      ...
                      border: "none", color: userReview.trim() ? V : "#6B7C93",
                ...
                {displayedText && (
                  <div className="mt-5 border border-[rgba(239,68,68,0.2)] bg-[rgba(239,68,68,0.03)] rounded-[10px]" style={{ padding: isMobile ? "20px" : "24px", animation: "fadeInUp 0.4s ease both" }}>
                    <div className="flex items-center gap-2 mb-3">
                      ...
                      <span className="text-[10px] text-[#6B7C93]">Réponse suggérée — prête à publier</span>
                    </div>
            ...
            <div className="flex gap-2 mb-5 flex-wrap">
              {SIGNAL_FILTERS.map(f => (
                <button key={f} onClick={() => setSignalFilter(f)} className="text-[11px] tracking-[1px] cursor-pointer font-[inherit] transition-all duration-300" style={{
                  ...
                  color: signalFilter === f ? "#6ee7b7" : "#6B7C93",
                }}>{f}</button>
              ))}
            </div>
                    ...
                    <div className="flex justify-between items-center gap-3 flex-wrap">
                      <div className="flex items-center gap-2.5 flex-1 min-w-0">
                        ...
                        <div className="min-w-0">
                          ...
                          <div className="text-[10px] text-[#6B7C93] flex gap-2 items-center flex-wrap">
                      ...
                      <div className="flex items-center gap-2">
                        {!isMobile && s.tags.map(t => (
                          <span key={t} className="text-[8px] text-[#6B7C93] tracking-[0.5px]" style={{ padding: "2px 8px", border: `1px solid ${VG(0.1)}` }}>{t}</span>
                        ))}
                        <span className="text-[13px] font-extrabold min-w-[36px] text-right" style={{ color: s.score >= 80 ? "#4ADE80" : s.score >= 60 ? "#fbbf24" : "#6B7C93" }}>{s.score}</span>
                      </div>
                    </div>
                    {expandedSignal === s.id && (
                      <div className="mt-3 pt-3" style={{ borderTop: `1px solid ${VG(0.06)}` }}>
                        <p className="text-[13px] text-[#6B7C93] leading-[1.8]">{s.detail}</p>
                      </div>
                    )}
                  </div>
                );
              ...
              <div className="flex gap-2.5" style={{ flexDirection: isMobile ? "column" : "row" }}>
                ...
                <button onClick={startMonitor} disabled={monitoring || !monitorUrl}
                  className="font-bold text-[11px] tracking-[1.5px] uppercase font-[inherit] whitespace-nowrap" style={{
                    ...
                    border: "none", color: !monitorUrl ? "#6B7C93" : V,
              ...
              {monitorError && !monitoring && (
                <div className="mt-5 text-center p-5" style={{ animation: "fadeInUp 0.4s ease both" }}>
                  <div className="inline-block border border-[rgba(239,68,68,0.3)] bg-[rgba(239,68,68,0.05)] rounded-lg" style={{ padding: "20px 32px" }}>
                    ...
                    <p className="text-xs text-[#6B7C93] leading-[1.6] max-w-[400px]">{monitorError}</p>
                ...
                <div className="mt-5">
                  ...
                  {monitorResults.rawData && (
                    <div className="grid gap-2 mb-4" style={{ gridTemplateColumns: isMobile ? "1fr 1fr" : "1fr 1fr 1fr 1fr" }}>
                      <div className="p-2.5 text-center" style={{ background: VG(0.03), border: `1px solid ${VG(0.06)}` }}>
                        ...
                        <div className="text-[8px] text-[#6B7C93] tracking-[1px] mt-0.5">CHARGEMENT</div>
                      </div>
                      <div className="p-2.5 text-center" style={{ background: VG(0.03), border: `1px solid ${VG(0.06)}` }}>
                        ...
                        <div className="text-[8px] text-[#6B7C93] tracking-[1px] mt-0.5">SÉCURITÉ</div>
                      </div>
                      <div className="p-2.5 text-center" style={{ background: VG(0.03), border: `1px solid ${VG(0.06)}` }}>
                        <div className="text-base font-extrabold text-white">{monitorResults.rawData.links?.internal || 0}</div>
                        <div className="text-[8px] text-[#6B7C93] tracking-[1px] mt-0.5">LIENS INT.</div>
                      </div>
                      <div className="p-2.5 text-center" style={{ background: VG(0.03), border: `1px solid ${VG(0.06)}` }}>
                        <div className="text-base font-extrabold text-white">{(monitorResults.rawData.socialLinks || []).length}</div>
                        <div className="text-[8px] text-[#6B7C93] tracking-[1px] mt-0.5">RÉSEAUX</div>
                      </div>
                    </div>
                  )}
                  ...
                  {monitorResults.techStack && (
                    <div className="mb-4" style={{ padding: "10px 14px", background: VG(0.03), border: `1px solid ${VG(0.06)}` }}>
                      <div className="text-[9px] text-[#6B7C93] tracking-[1px] mb-1.5">STACK TECHNIQUE DÉTECTÉE</div>
                      <div className="text-xs text-[#425466] leading-[1.6]">{monitorResults.techStack}</div>
                    </div>
                  )}
                    ...
                    <div className="grid gap-2 mb-4" style={{ gridTemplateColumns: isMobile ? "1fr" : "1fr 1fr" }}>
                      {monitorResults.strengths?.length > 0 && (
                        <div className="p-3 bg-[rgba(74,222,128,0.05)] border border-[rgba(74,222,128,0.15)]">
                          ...
                          {monitorResults.strengths.map((s, i) => <div key={i} className="text-[11px] text-[#6B7C93] mb-1 leading-[1.5]">+ {s}</div>)}
                        </div>
                      )}
                      {monitorResults.weaknesses?.length > 0 && (
                        <div className="p-3 bg-[rgba(239,68,68,0.05)] border border-[rgba(239,68,68,0.15)]">
                          ...
                          {monitorResults.weaknesses.map((w, i) => <div key={i} className="text-[11px] text-[#6B7C93] mb-1 leading-[1.5]">- {w}</div>)}
                        </div>
                      )}
                    </div>
                  )}

                  <div className="text-[9px] text-[#6B7C93] tracking-[1px] mb-2">SIGNAUX DÉTECTÉS</div>
                  {monitorResults.signals.map((s, i) => (
                    <div key={i} className="flex justify-between items-start gap-3" style={{ padding: "10px 0", borderBottom: `1px solid ${VG(0.05)}` }}>
                      <div className="flex-1">
                        <span className="text-xs text-[#425466] leading-[1.5]">{s.text}</span>
                        {s.recommendation && <div className="text-[10px] text-[#10b981] mt-1">{s.recommendation}</div>}
                      </div>
                      <span className="text-[9px] whitespace-nowrap shrink-0" style={{ padding: "2px 8px", border: `1px solid ${s.importance === "haute" ? "rgba(239,68,68,0.3)" : s.importance === "moyenne" ? "rgba(251,191,36,0.3)" : VG(0.1)}`, color: s.importance === "haute" ? "#ef4444" : s.importance === "moyenne" ? "#fbbf24" : "#6B7C93" }}>{(s.importance || "").toUpperCase()}</span>
                    </div>
                  ))}
                  ...
                  {monitorResults.summary && (
                    <div className="mt-4 p-3 bg-[rgba(16,185,129,0.05)] border border-[rgba(16,185,129,0.15)]">
                      ...
                      <div className="text-xs text-[#425466] leading-[1.6]">{monitorResults.summary}</div>
                    </div>
                  )}
                </div>
              )}
            ...
            <div className="overflow-hidden backdrop-blur-[12px]" style={{
              ...
              <div className="flex justify-between items-center" style={{ padding: "14px 20px", borderBottom: `1px solid ${VG(0.08)}` }}>
                <div className="flex gap-1.5 items-center">
                  ...
                  <span className="w-2.5 h-2.5 rounded-full bg-[#FEBC2E]" />
                  <span className="w-2.5 h-2.5 rounded-full bg-[#28C840]" />
                  <span className="text-[11px] text-[#6B7C93] ml-3">sentinel-prix.nervur.com</span>
                </div>
              ...
              <div style={{ padding: isMobile ? "20px" : "32px" }}>
                <div className="flex gap-5 mb-5 flex-wrap">
                  {COMPETITORS.map((c, i) => (
                    <div key={i} className="flex items-center gap-1.5">
                      ...
                      <span className="text-[10px] text-[#6B7C93] tracking-[0.5px]">{c.name}</span>
                    </div>
                  ))}
                </div>
                  ...
                  <svg role="img" aria-label="Graphique d'évolution des prix sur 30 jours" viewBox={`0 0 ${chartW} ${chartH + 20}`} className="w-full h-auto">
                    {[90, 110, 130, 150].map(p => (
                      <g key={p}>
                        ...
                        <text x={chartW + 5} y={getY(p) + 4} fill="#6B7C93" fontSize="9">€{p}</text>
                      </g>
                    ))}
                ...
                <div className="mt-6">
                  <h3 className="text-xs font-bold text-[#6B7C93] tracking-[2px] uppercase mb-3">Alertes récentes</h3>
                  <div className="flex flex-col gap-2">
                    {PRICE_ALERTS.map((a, i) => (
                      <div key={i} className="flex items-center gap-3" style={{
                        ...
                        <span className="text-xs flex-1" style={{ color: a.type === "danger" ? "#fca5a5" : "#6B7C93" }}>{a.text}</span>
                        <span className="text-[10px] text-[#6B7C93]">Jour {a.day}</span>
                      </div>
                    ))}
                  </div>
                </div>
        ...
        <section aria-label="Fonctionnalités incluses" className="mb-20">
          <div className="text-center mb-12">
            ...
            <p className="text-[15px] text-[#6B7C93] max-w-[560px] mx-auto leading-[1.7]">Un seul abonnement, zéro surprise. Réputation + veille concurrentielle + alertes marché.</p>
          </div>
              ...
              <div key={i} className="sentinel-feature p-6 rounded-[10px] cursor-default" style={{
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-[13px] text-[#6B7C93] leading-[1.7] m-0">{f.desc}</p>
                  </div>
                </div>
              </div>
            ))}
        ...
        <section aria-label="Tarification" className="mb-20" style={{ animation: "fadeInUp 0.8s ease 0.6s both" }}>
          <div className="max-w-[520px] mx-auto border border-[rgba(239,68,68,0.3)] bg-[rgba(239,68,68,0.03)] rounded-2xl text-center relative overflow-hidden" style={{ padding: isMobile ? "32px 24px" : "48px 40px" }}>
            ...
            <div className="text-left mb-8">
              {[
                ...
                <div key={i} className="flex items-center gap-2.5 py-2" style={{ borderBottom: i < 9 ? `1px solid ${VG(0.06)}` : "none" }}>
                  ...
                  <span className="text-[13px] text-[#425466]">{item}</span>
                </div>
              ))}
            </div>
            ...
            <p className="text-[11px] text-[#6B7C93] mt-4">Paiement sécurisé · Annulation à tout moment</p>
          </div>
        </section>
        ...
        <section aria-label="Appel à l'action" className="text-center rounded-xl" style={{
          ...
          <p className="text-[15px] text-[#6B7C93] max-w-[560px] mx-auto mb-8 leading-[1.7]">
      ...
      <footer className="flex justify-between items-center" style={{ padding: isMobile ? "30px 20px" : "40px 48px", borderTop: `1px solid ${VG(0.08)}`, flexDirection: isMobile ? "column" : "row", gap: "12px" }}>
        <span className="text-[11px] text-[#6B7C93] tracking-[1px]">NERVÜR © 2026</span>
        <span className="text-[11px] text-[#6B7C93]">SENTINEL — Bouclier E-Réputation & Veille IA</span>
      </footer>
    </div>
  );
}
